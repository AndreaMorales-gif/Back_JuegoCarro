...
@Service
@Validated
public class UseCaseUpdatePodium {
    ...
    public UseCaseUpdatePodium(RepositoryPodium repositoryPodium, PodioMapper podioMapper) {
        this.repositoryPodium = repositoryPodium;
        this.podioMapper = podioMapper;
    }

    public Mono<PodiumDTO> updatePodium(PodiumDTO podiumDTO){
