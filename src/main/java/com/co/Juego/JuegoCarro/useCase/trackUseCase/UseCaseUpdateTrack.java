...
@Service
@Validated
public class UseCaseUpdateTrack {

    private final RepositoryTrack repositoryTrack;
    private final PistaMapper pistaMapper;

    @Autowired
    public UseCaseUpdateTrack(RepositoryTrack repositoryTrack, PistaMapper pistaMapper) {
        this.repositoryTrack = repositoryTrack;
        this.pistaMapper = pistaMapper;
    }

    public Mono<TrackDTO> updateTrack(TrackDTO trackDTO){
